      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="hover:text-purple-300 transition-colors cursor-pointer"><Link href=""> Dashboard </Link></li>
        ...
        <div className="border-t border-purple-500/20 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            ©{year} Reelify. All rights reserved. Built on blockchain for true decentralization.
          </p>
